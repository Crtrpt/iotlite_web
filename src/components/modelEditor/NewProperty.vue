    ...
    <b-tab title="属性">
                   <b-button-group class="mt-2 mb-2">
                        <b-modal ref="new-property" title="属性" hide-footer>
                            <b-form>
                              <b-form-group label="名称" description="属性名称" > <b-form-input v-model="curDevice.name" placeholder="属性名称" required ></b-form-input> </b-form-group>
                              <b-form-group label="描述" description="对属性的描述" > <b-form-input v-model="curDevice.description" placeholder="描述" required ></b-form-input> </b-form-group>
