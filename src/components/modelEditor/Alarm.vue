  ...
  <b-tab title="报警">
    <b-button-group class="mt-2 mb-2">
      <b-modal ref="new-alarm" title="报警" hide-footer>
        <b-form>
          <b-form-group label="名称" description="报警名称">
            <b-form-input
          ...
          <b-form-group label="描述" description="对报警的描述">
            <b-form-input
          ...
          <b-form-group label="报警级别" description="报警级别">
            <b-form-input
              v-model="curData.level"
              placeholder="级别"
              required
            ></b-form-input>
          </b-form-group>
